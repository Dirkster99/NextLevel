...
Dirk: I have added the sDBServerName parameter to generate the caption
      for one main menu entry at construction time (when HTML page loads)
*/
function initjsDOMenu(sDBServerName)
{
  //This code is added by Dirk to activate inline documentation, if available
  if(document.getElementById('content') != null)
  if(document.getElementById && document.createElement) {initCollapse();}

  // Public method, call function in config file for the menu
  if (document.createElement && document.getElementById) {
    createjsDOMenu(sDBServerName);
  }
}
