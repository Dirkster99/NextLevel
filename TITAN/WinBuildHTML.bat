...
php ..\GenIdx\GenIdx.php TITAN_SQL\idx.txt TITAN_SQL\TabCat.txt ZEUS TITAN dbo header.xml > TITAN_SQL\idx.xml

REM Build HTML Documents for the TITAN Sample DATABASE
..\bin\nextlevel -idx TITAN_SQL\idx.xml -DirOut TITAN_HTML\ -WinHelp
